# Generated by Powerlevel10k configuration wizard on 2023-10-14 at 16:45 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#00FF00'
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#FF0000'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#333333'
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#FF4500'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#FF4500'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#FF4500'
  # Display anchor directory segments in bold.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_BOLD=false # true
  ...
  function my_git_formatter() {
    ...
    local branch_colour='%196F'
    # ANSI 256 colour mode
    if (( $1 )); then
      # Styling for up-to-date Git status.
      local       meta='%244F'  # grey foreground
      local      clean='%2F'    # green foreground
      local   modified='%214F'  # orange foreground
      local  untracked='%14F'   # blue foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${branch_colour}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR="#FF00FF"
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#333333'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='#333333'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#333333'
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#333333'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND="#00FF00"
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND="#333333"
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='✔'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND="#00FF00"
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND="#333333"
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND="#FF0000"
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND="#FF0000"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND="#FF4500"
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND="#333333"
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND="#FF4500"
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND="#000000"
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND="#FF0000"
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND="#FF4500"
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND='#FFD242'
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND='#3770A0'
